...
class WriteTableOperator(BaseOperator):
    ...
    def __init__(
        ...
        *,
        ...
        object_storage_path: UPath | ObjectStoragePath | None = None,
        object_storage_format: str | Format | None = None,
...
class ReadTableOperator(BaseOperator):
    ...
    def __init__(
        ...
        *,
        ...
        object_storage_path: UPath | ObjectStoragePath | None = None,
        object_storage_format: str | Format | None = None,
        table_reader: dict[str, Any] | None = None,
        control_attributes: dict[str, Any] | None = None,
        unordered: bool | None = None,
        response_parameters: dict[str, Any] | None = None,
        omit_inaccessible_columns: bool | None = None,
        ytsaurus_conn_id: str = YTsaurusHook.default_conn_name,
        **kwargs: Any,
    ) -> None:
